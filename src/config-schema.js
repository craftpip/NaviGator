...
export const CONFIG_SCHEMA = [
  ...
  { key: "DEFAULT_EXTRACT_POST_PROCESSOR", category: "extractor", type: "string", fallback: "", applies: "hot", description: "Default post-processor model id applied to every unmatched page (empty = no post-processor). Must be a model id from POST_PROCESSOR_MODELS. Hot-applied." }
];
