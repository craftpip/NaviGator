export const CONFIG_SCHEMA = [
  ...
  { key: "SEARCH_KEEP_MIN_WORKING_WINDOWS", category: "search", type: "integer", fallback: 2, applies: "hot", description: "Min warm windows kept open per engine." },
  ...
  { key: "HUMAN_TYPING_DELAY", category: "search", type: "integer", fallback: 15, applies: "hot", description: "Delay per character typed (ms)." },
